...
class Foo:
    """Esta é um classe de exemplo

    Esta classe contém funções e exemplos de documentações de funções.
    """
    ...
    def multiplica(self,
        ...
        Multiplica x e y. Se z for enviado, multuiplica x, y, z.
        """
        if z is None:
            return x * y
        return x * y * z
